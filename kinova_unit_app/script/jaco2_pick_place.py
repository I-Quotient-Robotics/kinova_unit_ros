...
ready_angles = {}
ready_angles['j2s6s200'] = [283.118682861, 162.867752075, 43.4267578125, 265.080688477, 257.716766357, 288.920166016, 0.0]
ready_angles0 = {}
...
home_angles = {}
home_angles['j2s6s200'] = [275.938201904, 212.978210449, 98.8227462769, 359.023712158, 240.306106567, 178.173019409, 0.0]
home_angles0 = {}
...
class Jaco2PickPlace():
    def __init__(self, arm_name):
        ...
        self.__pose_action_client = actionlib.SimpleActionClient('j2s6s200_driver/pose_action/tool_pose',
                                                               kinova_msgs.msg.ArmPoseAction)
        self.__joints_action_client = actionlib.SimpleActionClient('j2s6s200_driver/joints_action/joint_angles',
                                                                 kinova_msgs.msg.ArmJointAnglesAction)
        self.__gripper_action_client = actionlib.SimpleActionClient('j2s6s200_driver/fingers_action/finger_positions',
