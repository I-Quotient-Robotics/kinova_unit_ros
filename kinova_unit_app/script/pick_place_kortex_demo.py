...
class PickPlace:
    ...
    def initialize(self):
        rospy.loginfo('Move to Standby')
        self.__move_by_joint_angle(standby_angles)


def main():
    moveit_commander.roscpp_initialize(sys.argv)
    rospy.init_node('pick_place_kortex_demo_node')
